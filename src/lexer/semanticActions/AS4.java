    ...
    public void execute(ScannerContext context, int symbol) {
        ...
        try {
            ...
            if (value != 0.0f &&
                ...
                context.setToken(TokenType.ERROR, "Error Lexico: Constante FLOAT32 fuera de rango -> " + lexeme, context.getLine());
            } else {
            ...
            context.setToken(TokenType.ERROR, "Error lexico: Formato inválido de constante FLOAT32 -> " + lexeme, context.getLine());
        }
